    ...
    >
      ...
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-8 mb-12">
        ...
        <div class="flex items-center gap-3">
          <a
            href="https://www.linkedin.com/in/juan-camilo-rodr%C3%ADguez-989030245/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            class="flex items-center justify-center w-9 h-9 border transition-colors duration-200"
            [class]="isDark()
          ...
          <a
            href="https://github.com/Milo0728"
          ...
          <a
            href="mailto:jcrodriguezc0728@hotmail.com"
            aria-label="Email"
            class="flex items-center justify-center w-9 h-9 border transition-colors duration-200"
            [class]="isDark()
              ? 'border-neutral-700 text-neutral-400 hover:border-white hover:text-white'
      ...
      <!-- Bottom row -->
      <div
        class="border-t pt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2"
        [class]="isDark() ? 'border-neutral-800' : 'border-neutral-200'"
      >
        <p class="text-neutral-400 text-xs">{{ t()['footer.rights'] }}</p>
        <p class="text-neutral-400 text-xs">{{ t()['footer.made'] }}</p>
      </div>
