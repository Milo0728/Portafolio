  ...
  template: `
    <section id="hero" class="grid grid-cols-1 md:grid-cols-2 min-h-screen">
      ...
      <div class="flex flex-col justify-center px-12 lg:px-20 py-32">
        ...
        <p class="text-neutral-400 text-sm leading-relaxed max-w-xs mb-10">
          {{ t()['hero.bio'] }}
        </p>
        ...
        <div class="flex gap-3">
          <a
            ...
            aria-label="LinkedIn"
            class="flex items-center justify-center w-8 h-8 border text-xs font-bold transition-colors duration-200"
            [class]="isDark()
