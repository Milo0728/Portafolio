...
export const PROJECTS: Project[] = [
  ...
  {
    title: 'Analify',
    description: 'Plataforma de visualización de datos musicales que consume la Spotify API y aplica técnicas de Machine Learning para descubrir patrones en hábitos de escucha y géneros musicales.',
    image: 'assets/images/project-analify.png',
    technologies: ['Python', 'Spotify API', 'Machine Learning', 'Data Viz'],
    demoUrl: null,
    githubUrl: 'https://github.com/Milo0728/spotify-app',
  },
  {
    title: 'App de Vuelos',
